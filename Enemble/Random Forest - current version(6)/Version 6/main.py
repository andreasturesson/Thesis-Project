'''
For clarification go to the ReadMe file.
'''
...
# All DGA-domains and Alexa_Majestic(legitimate)
...
def writeResultToExcel():
    ...
    randomForest_Result.to_excel('pic/trial4.xlsx', index=False, header=True)
...
def finalResult():
    ...
    mcNemarsTest.to_excel('test_result/mcNemars_final_result_X.xlsx', index=False, header=True)
